...
REMOVED = {
    ...
    "agent_runtime.decision_schema": ("to_decision_jsonable",),
    ...
    "agent_runtime.packets": ("latest_packets_for_task",),
...
KEPT = {
    ...
    "agent_runtime.decision_schema": ("parse_structured_decision", "DecisionType"),
    ...
    "agent_runtime.paths": ("packet_artifacts_dir", "store_root"),
