> Historical fork design record, archived during upstream synchronization. Paths and status below describe the original fork snapshot, not the current implementation contract.
