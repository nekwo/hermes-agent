...
| `harness serve boot timeline: <k=v …>` | `hermes_cli/harness_parts/serve.py:1857-1859`, line built by `boot_timeline.py:173-178` | operator grep; the same block also rides the `ready` frame (`serve.py:1751`) |
