...
| `harness serve boot timeline: <k=v …>` | `hermes_cli/harness_parts/serve.py:3968-3972`, line built by `BootTimeline.log_line` (`boot_timeline.py:173-178`) | operator grep; the same block also rides the `ready` frame (`serve.py:3894`) |
