...
| `harness serve boot timeline: <k=v …>` | `hermes_cli/harness_parts/serve.py:1964-1966`, line built by `BootTimeline.log_line` (`boot_timeline.py:173-178`) | operator grep; the same block also rides the `ready` frame (`serve.py:1751`) |
...
(`hermes_cli/harness.py:876-886`, handler `:3075-3107`) — read-only, honest
