...
(`persona_commands.py:6462`, `agent_runtime/persona_chat_history.py:234`) via
`_resolve_chat_model_override` (`:6916`), called at `:3455`. Its scope is literally
