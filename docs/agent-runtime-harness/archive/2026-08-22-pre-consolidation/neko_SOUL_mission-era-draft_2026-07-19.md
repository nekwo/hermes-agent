> **Archived 2026-08-29.** This is the superseded mission-era draft of Neko's
> SOUL, recovered from `profiles/neko/personas/SOUL.md` (mtime 2026-07-19) —
> a path nothing serves (`_mission_chat_soul_overlay` resolves against the
> profile ROOT). The served `profiles/neko/SOUL.md` (2026-07-23) is the
> deliberate rewrite that dropped this draft's mission-lane machinery
> (blueprints, proof gates, run budgets) ahead of the 2026-07-30 mission-lane
> removal. Preserved verbatim below the divider; the orphan was deleted from
> the profile the day this was archived (operator-approved).
