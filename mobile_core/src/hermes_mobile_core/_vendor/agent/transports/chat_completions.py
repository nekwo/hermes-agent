...
from hermes_mobile_core._vendor.agent.lmstudio_reasoning import resolve_lmstudio_effort
from hermes_mobile_core._vendor.agent.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from hermes_mobile_core._vendor.agent.prompt_builder import DEVELOPER_ROLE_MODELS
from hermes_mobile_core._vendor.agent.transports.base import ProviderTransport
from hermes_mobile_core._vendor.agent.transports.types import NormalizedResponse, ToolCall, Usage
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        """
        from hermes_mobile_core._vendor.providers.base import OMIT_TEMPERATURE
        ...
        if extra_body:
            ...
            try:
                from hermes_mobile_core._vendor.agent.gemini_native_adapter import is_native_gemini_base_url
...
from hermes_mobile_core._vendor.agent.transports import register_transport  # noqa: E402
