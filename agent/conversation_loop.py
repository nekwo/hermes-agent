        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                def _perform_api_call(next_api_kwargs):
                    # Transport preflight runs per PHYSICAL attempt: a middleware
                    # redirect or relay retry can hand back kwargs that never went
                    # through the build-time preflight above.
                    if agent.api_mode == "codex_responses":
