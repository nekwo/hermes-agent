...
def _load_skill_blocks(
    ...
    missing_label=lambda ident: ident, disabled_names: set | None = None, disabled_as_missing: bool = False, required_skill_names: set[str] | None = None,
...
def build_preloaded_skills_prompt(skill_identifiers: list[str], task_id: str | None = None, *, required_skill_names: set[str] | None = None) -> tuple[str, list[str], list[str]]:
