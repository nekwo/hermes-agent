...
CLARIFY_SCHEMA = {
    "name": "clarify",
    "description": (
        "Ask the operator a question before proceeding. Multiple choice: pass up to 4 `choices` (rendered as pickable rows -- never enumerate options inside `question`); set `multi_select` for checkbox selection of several. Open-ended: omit `choices`. Disambiguator: not for yes/no confirmation of dangerous commands (terminal handles that)."
    ),
    "parameters": {
        "type": "object",
        "properties": {
