...
SKILL_MANAGE_SCHEMA = {
    "name": "skill_manage",
    "description": (
        "Create / update / delete skills (your procedural memory). Actions: create, patch (preferred for fixes), edit (full rewrite), delete (pass absorbed_into), write_file, remove_file. Disambiguator: skill_manage WRITES skills; skill_search / skill_view READ them. Call tool_describe for the authoring checklist."
    ),
    "parameters": {
        "type": "object",
        "properties": {
